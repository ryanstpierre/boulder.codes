    ...
    <div className="container mx-auto px-6">
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <a href="mailto:builders@boulder.codes" className="text-blue-400 hover:text-blue-300">
            builders@boulder.codes
          </a>
      ...
      <div className="mt-8 pt-8 border-t border-slate-800 text-center">
        <p className="text-gray-500">
          ...
          <a href="https://buildersroom.boulder.codes" className="text-blue-400 hover:text-blue-300">buildersroom.boulder.codes</a>
        </p>
      </div>
    </div>
  </footer>
